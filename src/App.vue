...
<template>
  <header class="h-20 w-screen flex flex-row px-10 bg-gray-50 items-center text-center justify-between" >
    <img alt="Vue logo" class="logo h-12" src="@/assets/253822.png"/>
    <nav class="w-auto text-lg font-bold">
